...
export default function Challenge(props: { title: string, children: string, Id: number, Index: number, setIndex: Dispatch<SetStateAction<number>> }) {
  const handleSetIndex = (Id: number) => props.Index !== Id && props.setIndex(Id);
  return (
    <>
      <div
      ...
      >
        ...
        <div className="flex items-center justify-center pr-10">
          {props.Index !== props.Id ? (
            ...
            <HiX className="w-6 h-6 group-hover:text-dark-headline text-primary" onClick={() => handleSetIndex(0)}/>
          )}
        </div>
      </div>
            ...
            <table className="min-w-max w-full table-auto">
              ...
              <tbody className="text-dark-headline dark:text-light-headline text-sm font-light">
                <tr className="border-b border-dark-background dark:border-light-background">
                  ...
                  <td className="py-3 px-6 text-center">
                    <div className="flex items-center justify-center">
                      <img
                        className="w-6 h-6 rounded-full border-dark-backgroun border transform hover:scale-125"
                        src="https://randomuser.me/api/portraits/men/1.jpg"
                      />
                      <img
                        className="w-6 h-6 rounded-full border-dark-backgroun border -m-1 transform hover:scale-125"
                ...
                <tr className="border-b border-dark-background dark:border-light-background">
                  ...
                  <td className="py-3 px-6 text-center">
                    <span className="bg-secondary py-1 px-3 rounded-full text-xs">
                      Medium
                    </span>
                  </td>
                  <td className="py-3 px-6 text-center">
                ...
                <tr className="border-b border-dark-background dark:border-light-background">
                  ...
                  <td className="py-3 px-6 text-center">
                    <span className="bg-tertiary py-1 px-3 rounded-full text-xs">
                      Hard
                    </span>
                  </td>
                  <td className="py-3 px-6 text-center">
